 ...
 * Use the [GoMenuFragmento.newInstance] factory method to
 * create an instance of this fragment.
 */
class GoMenuFragmento : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_go_menu, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment GoMenuFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GoMenuFragmento().apply {
